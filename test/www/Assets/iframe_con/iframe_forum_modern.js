...
(function() {
    ...
    ver(base + stickyforum_DESE),
    ver(base + unstickyforum_DESE)

  ], 0, function () {

    window.STICKY_DESC  = FORUM_STICKY;
    window.THREADS_DESC = FORUM_THREADS;

    loadSeq([

      ver(base + stickyforum_ASE),
      ver(base + unstickyforum_ASE),
      ver("../../Assets/loader.js")

    ], 0, function () {

      window.STICKY_ASC  = FORUM_STICKY;
      window.THREADS_ASC = FORUM_THREADS;
