/* =====================================================
   ...
   ORGANIZED – ES3 SAFE
   all labels from THREAD_LANG_AR
===================================================== */

window.THREAD_TEMPLATES = (function () {

    /* ================= LANG ================= */

    var L = window.THREAD_LANG;
    var common = window.LANG_COMMON;
     ...
     function mapConHTML(THREAD) {

    return '<div class="map-con-info">' +
        '<div class="child-post-con-info">' +
            ...
            '<div class="post-list-button" data-copy>' +
                '<span>' + common.forum + ': ' + THREAD.forum_type + THREAD.forum_id + '<br>' +
            ...
            '<div class="post-list-button" data-copy>' +
                ...
                '<span>' + common.thread + ': ' + THREAD.thread_id + '<br>' +
...
function buildItemGroup(RAW_JSON, postId) {
    ...
    /* use global RAW only on single post page */
...
if (RAW_JSON && RAW_JSON.long_text) {
    ...
    if ((RAW_JSON && RAW_JSON.postid) || postId) {

        var pid = (RAW_JSON && RAW_JSON.postid)
            ? RAW_JSON.postid
            : postId;

        var po =
            "https://nasser-alyamani.org/showthread.php?p=" + pid;
    ...
    else if (window.THREAD && window.THREAD.threadid) {
        tid = window.THREAD.threadid;
    }

    if (tid) {

        var th =
            "https://nasser-alyamani.org/showthread.php?t=" + tid;
...
var FORUM_TYPE = THREAD.forum_type || "";
var THREAD_ID  = THREAD.thread_id  || "";
        ...
        return (
            ...
            '<div id="box">' +
			'<div id="copyMenu" class="copy-menu no_copy"> <a href="javascript:void(0)" id="cmCopy">'+window.THREAD_LANG.copy_text+'</a></div>'+
