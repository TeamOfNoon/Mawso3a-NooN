...
window.FORUM_TEMPLATES = (function () {

  var L = window.FORUM_LANG;
  var L_COMMON = window.LANG_COMMON;
...
function mapConHTML() {
    ...
    return '<div class="map-con-info">' +
        '<div class="child-post-con-info">' +
			...
			'<span class="you_here">' + L_COMMON.you_here + '</span>' +
                '<span>' + L_COMMON.forum + ': ' + FORUM_THREADS.forumtype + FORUM_THREADS.forumid + '<br>' +
  ...
  return {
    ...
    page : function () {
      ...
      var HEADER = window["HEADER_BAR_HTML_TPL"] || "";
      var FOOTER = window["FOOTER_BAR_HTML_TPL"] || "";
      var MENE   = window["MENE_BAR_HTML_TPL"] || "";
      ...
      return (
        '<div id="box">' +
		  ...
		  '<div class="map no_copy"><div class="map_button">'+ L_COMMON.map +'</div></div>'+
      ...
      '<div class="forumSticky">' +
        ...
        '<div class="threadMeta">' +
          ...
          '<div class="threadReplies">' +
            '<i class="demo-icon icon-comment-1"></i>(' +
              '{{replycount}} ' + L.repliesSuffix +
            ')' +
          '</div>' +
