...
if (window.location.protocol === "http:" || window.location.protocol === "https:") {
    // في السيرفر → استخدم relative path
    gParentDataFile = "www/Assets/template/parentdata.js";
} else {
   
    gParentDataFile = window.location.href .replace(/[^\/]+$/, '') .split('/') .slice(-2, -1)[0] + "/Assets/template/parentdata.js";
